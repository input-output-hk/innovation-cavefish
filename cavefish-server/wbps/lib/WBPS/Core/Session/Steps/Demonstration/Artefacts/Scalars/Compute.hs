module WBPS.Core.Session.Steps.Demonstration.Artefacts.Scalars.Compute (
  compute,
) where
...
import WBPS.Core.Session.Steps.Demonstration.Artefacts.Rho (
  Rho,
  encryptionKeyPowRho,
  generatorPowRho,
 )
import WBPS.Core.Session.Steps.Demonstration.Artefacts.Scalars (Scalars (Scalars))
