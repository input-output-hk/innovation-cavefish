...
We estimate the arithmetic complexity of the relation in~\ref{narg} in terms of number of contraints, proving key size and proof size.
...
\toprule
  & Bitcoin & Cardano \\
\midrule
Curve        & Secp256k1   & Ed25519      & 85      \\
Hash          & SHA-256   & SHA-512      & 79      \\
\midrule
Blindness type     & predicate & partial & predicate & partial \\
 & Threshold for amount& & $TX.out \le t$  & 333b blinded\\
Transaction size & 256B & &  285B\\
\midrule
Proving key size \\
Proving key verification time \\
