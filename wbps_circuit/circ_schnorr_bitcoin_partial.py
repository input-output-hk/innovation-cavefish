...
data = {
    ...
    "rho": "2389324445",
    "msg_pub": [random.randint(0, 1) for _ in range(254*8)],
    "msg_priv": [random.randint(0, 1) for _ in range(288)]
}

# Write the data to input.json
with open("circ_schnorr_bitcoin_partial_input.json", "w") as json_file:
    json.dump(data, json_file, indent=4)

print("circ_schnorr_bitcoin_partial_input.json file has been created with the specified fields.")
