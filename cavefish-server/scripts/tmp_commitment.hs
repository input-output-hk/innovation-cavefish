...
import WBPS.Core.Session.Demonstration.Commitment.Build (build)
import WBPS.Core.Session.Demonstration.Commitment.Commitment (Message (..))
import WBPS.Core.Session.Demonstration.Scalars (Scalars (..), compute)
