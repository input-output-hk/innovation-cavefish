...
\textcolor{orange}{mr: not sure if we want to discuss multi-asset support. We could make this section leaner, as we focus more on optimality in communication?}
...
The $\fun{auxData}$ is a field for arbitrary extra data encoded as a bytestring, 
e.g. a "note".
